...
// tipso
    ...
    mix.sass('../../vendors/datatables/css/responsive.dataTables.scss', 'vendors/datatables/css/responsive.dataTables.css');
    ...
    mix.scripts(
        [
            ...
            '../../js/tether.min.js',
            '../../js/bootstrap.min.js',
            '../../vendors/slimscroll/js/jquery.slimscroll.min.js'
